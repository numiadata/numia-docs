...
Each NumiaAI tool is designed to handle specific aspects of data interaction. 

<Image
  src="/media/ai/numia-ai-diagram-light.png"
  srcDark="/media/ai/numia-ai-diagram-dark.png"
/>

The following accordions provides details and examples of these tool:
